...
class LoginPage(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        main_frame = tk.Frame(self, bg="#708090", height=431, width=626)  # background
        main_frame.pack(fill="both", expand="true")

        self.geometry("626x431")  # tamanho da janela em pixels
        self.resizable(0, 0)
...
class SignupPage(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def validate_user(username): # checar no BD
            try:
                with open("credentials.txt", "r") as credentials:
                    for line in credentials:
                        line = line.split(",")
